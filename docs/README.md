...
- Assessment operator: read the [Operator Runbook](operator-runbook.md). To put
...
| Learn and verify the workflow | [Verified User Journey](USER_JOURNEY.md), [UAT Plan](UAT_PLAN.md), [User Guide](user-guide.md), [First User Journey](first-user-journey.md) |
